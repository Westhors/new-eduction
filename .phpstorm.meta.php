    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Interfaces\CouponRepositoryInterface' => \App\Repositories\CouponRepository::class,
            'App\Interfaces\CourseDetailRepositoryInterface' => \App\Repositories\CourseDetailRepository::class,
            'App\Interfaces\CourseRepositoryInterface' => \App\Repositories\CourseRepository::class,
            'App\Interfaces\CurriculaRepositoryInterface' => \App\Repositories\CurriculaRepository::class,
            'App\Interfaces\StageRepositoryInterface' => \App\Repositories\StageRepository::class,
            'App\Interfaces\StudentRepositoryInterface' => \App\Repositories\StudentRepository::class,
            'App\Interfaces\SubjectRepositoryInterface' => \App\Repositories\SubjectRepository::class,
            'App\Interfaces\TeacherRepositoryInterface' => \App\Repositories\TeacherRepository::class,
    ...
    override(\config(), map([
            ...
            'auth.guards.teachers.driver' => 'string',
            'auth.guards.teachers.provider' => 'string',
            'auth.guards.students.driver' => 'string',
            'auth.guards.students.provider' => 'string',
            'auth.guards.parents.driver' => 'string',
            'auth.guards.parents.provider' => 'string',
            ...
            'auth.providers.teachers.driver' => 'string',
            'auth.providers.teachers.model' => 'string',
            'auth.providers.students.driver' => 'string',
            'auth.providers.students.model' => 'string',
            'auth.providers.parents.driver' => 'string',
            'auth.providers.parents.model' => 'string',
            ...
            'auth.passwords.teachers.provider' => 'string',
            'auth.passwords.teachers.table' => 'string',
            'auth.passwords.teachers.expire' => 'integer',
            'auth.passwords.teachers.throttle' => 'integer',
            'auth.passwords.students.provider' => 'string',
            'auth.passwords.students.table' => 'string',
            'auth.passwords.students.expire' => 'integer',
            'auth.passwords.students.throttle' => 'integer',
            ...
            'filesystems.links.C:\laragon\www\api.new-eduction\public\storage' => 'string',
...
'auth.guards.admins.provider','auth.guards.teachers.driver','auth.guards.teachers.provider','auth.guards.students.driver','auth.guards.students.provider',
'auth.guards.parents.driver','auth.guards.parents.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.admins.driver','auth.providers.admins.model','auth.providers.teachers.driver','auth.providers.teachers.model',
'auth.providers.students.driver','auth.providers.students.model','auth.providers.parents.driver','auth.providers.parents.model','auth.passwords.users.provider',
...
'auth.passwords.admins.expire','auth.passwords.admins.throttle','auth.passwords.teachers.provider','auth.passwords.teachers.table','auth.passwords.teachers.expire',
'auth.passwords.teachers.throttle','auth.passwords.students.provider','auth.passwords.students.table','auth.passwords.students.expire','auth.passwords.students.throttle',
...
'filesystems.disks.avatar.driver','filesystems.disks.avatar.root','filesystems.disks.avatar.url','filesystems.disks.avatar.visibility','filesystems.links.C:\\laragon\\www\\api.new-eduction\\public\\storage',
...
'sanctum.csrf-cookie','teacher.index','teacher.store',
'teacher.show','teacher.update','teacher.destroy','course.index','course.store','course.show','course.update',
'course.destroy','course-detail.index','course-detail.store',
'course-detail.show','course-detail.update','course-detail.destroy','country.index','country.store','country.show',
'country.update','country.destroy','curriculum.index',
'curriculum.store','curriculum.show','curriculum.update','curriculum.destroy',
'stage.index','stage.store','stage.show','stage.update','stage.destroy','subject.index','subject.store','subject.show','subject.update',
'subject.destroy','student.index',
'student.store','student.show','student.update','student.destroy','libraries.index','libraries.store',
'libraries.show','libraries.update','libraries.destroy','storage.local',);
...
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.api.new-eduction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'STRIPE_SECRET_KEY','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',);
